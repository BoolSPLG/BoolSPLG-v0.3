...
/* This reduction interleaves which threads are active by using the modulo
   ...
   inefficient */
template <class T>
__global__ void reduce0_max(T* g_idata, T* g_odata, unsigned int n) {
    // Handle to thread block group
    cg::thread_block cta = cg::this_thread_block();
    T* sdata = SharedMemory<T>();
...
*/
template <class T>
__global__ void reduce1_max(T* g_idata, T* g_odata, unsigned int n) {
    // Handle to thread block group
    cg::thread_block cta = cg::this_thread_block();
    T* sdata = SharedMemory<T>();
...
*/
template <class T>
__global__ void reduce2_max(T* g_idata, T* g_odata, unsigned int n) {
    // Handle to thread block group
    cg::thread_block cta = cg::this_thread_block();
    T* sdata = SharedMemory<T>();
...
*/
template <class T>
__global__ void reduce3_max(T* g_idata, T* g_odata, unsigned int n) {
    // Handle to thread block group
    cg::thread_block cta = cg::this_thread_block();
    T* sdata = SharedMemory<T>();
...
*/
template <class T, unsigned int blockSize>
__global__ void reduce4_max(T* g_idata, T* g_odata, unsigned int n) {
    // Handle to thread block group
    cg::thread_block cta = cg::this_thread_block();
    T* sdata = SharedMemory<T>();
    ...
    if (cta.thread_rank() < 32) {
        ...
        {
            //mySum += tile32.shfl_down(mySum, offset);
            mySum = max(abs(mySum), abs(tile32.shfl_down(mySum, offset)));
        }
    }
...
*/
template <class T, unsigned int blockSize>
__global__ void reduce5_max(T* g_idata, T* g_odata, unsigned int n) {
    // Handle to thread block group
    cg::thread_block cta = cg::this_thread_block();
    T* sdata = SharedMemory<T>();
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Wrapper function for Reduction max kernel launch
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <class T>
...
/* This reduction interleaves which threads are active by using the modulo
   ...
   inefficient */
template <class T>
__global__ void reduce0_min(T* g_idata, T* g_odata, unsigned int n) {
    // Handle to thread block group
    cg::thread_block cta = cg::this_thread_block();
    T* sdata = SharedMemory<T>();
...
*/
template <class T>
__global__ void reduce1_min(T* g_idata, T* g_odata, unsigned int n) {
    // Handle to thread block group
    cg::thread_block cta = cg::this_thread_block();
    T* sdata = SharedMemory<T>();
...
*/
template <class T>
__global__ void reduce2_min(T* g_idata, T* g_odata, unsigned int n) {
    // Handle to thread block group
    cg::thread_block cta = cg::this_thread_block();
    T* sdata = SharedMemory<T>();
...
*/
template <class T>
__global__ void reduce3_min(T* g_idata, T* g_odata, unsigned int n) {
    // Handle to thread block group
    cg::thread_block cta = cg::this_thread_block();
    T* sdata = SharedMemory<T>();
...
*/
template <class T, unsigned int blockSize>
__global__ void reduce4_min(T* g_idata, T* g_odata, unsigned int n) {
    // Handle to thread block group
    cg::thread_block cta = cg::this_thread_block();
    T* sdata = SharedMemory<T>();
    ...
    if (cta.thread_rank() < 32) {
        ...
        {
            //mySum += tile32.shfl_down(mySum, offset);
            mySum = min(abs(mySum), abs(tile32.shfl_down(mySum, offset)));
        }
    }
...
*/
template <class T, unsigned int blockSize>
__global__ void reduce5_min(T* g_idata, T* g_odata, unsigned int n) {
    // Handle to thread block group
    cg::thread_block cta = cg::this_thread_block();
    T* sdata = SharedMemory<T>();
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Wrapper function for Reduction min kernel launch
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <class T>
...
// Instantiate the reduction function for int types
template void reduce_max<int>(int size, int threads, int blocks, int whichKernel, int* d_idata, int* d_odata);

// Instantiate the reduction function for int types
template void reduce_min<int>(int size, int threads, int blocks, int whichKernel, int* d_idata, int* d_odata);
